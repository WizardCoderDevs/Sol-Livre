  ...
  return (
    <section id="cta" className="py-24 px-6 bg-background relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl glass rounded-[4rem] px-12 py-24 text-center">
        ...
        <p className="text-foreground/60 text-lg max-w-xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pt-16 border-t border-white/5 text-left">
          <div className="md:col-span-1">
             <div className="font-display text-xl font-bold mb-6 tracking-widest text-accent">SOL LIVRE</div>
             <p className="text-foreground/40 text-sm">Consultoria de Inteligência Energética. Especialistas em sistemas híbridos e ativos financeiros solares.</p>
          </div>
          
          <div>
            <h4 className="font-bold text-xs uppercase tracking-widest text-foreground/40 mb-6">Contato</h4>
          ...
          <div>
            <h4 className="font-bold text-xs uppercase tracking-widest text-foreground/40 mb-6">Links</h4>
            <div className="flex flex-col gap-4 text-sm font-medium">
          ...
          <div>
            <h4 className="font-bold text-xs uppercase tracking-widest text-foreground/40 mb-6">Social</h4>
        ...
        <div className="mt-20 pt-8 border-t border-white/5 text-center text-xs text-foreground/20">
