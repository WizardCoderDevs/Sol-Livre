...
export const Trust = () => {
  return (
    <section className="py-20 border-y border-white/5 bg-background overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:max-w-xs text-center md:text-left">
            ...
            <p className="text-foreground/50 text-xs">Apenas tecnologias líderes globais Tier 1.</p>
          </div>
